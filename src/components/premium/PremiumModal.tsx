  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white admin-dark:bg-gray-800 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          {/* Current Limitation */}
          <div className="bg-yellow-50 admin-dark:bg-yellow-900/20 border border-yellow-200 admin-dark:border-yellow-800 rounded-lg p-4 mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-yellow-800 admin-dark:text-yellow-200">Has alcanzado el límite de tu plan Gratis</h3>
                <p className="text-sm text-yellow-700 admin-dark:text-yellow-300">Actualmente tienes 1/1 tiendas. Actualiza para crear más.</p>
              </div>
            </div>
          </div>
