...
<div className="p-6">
  {/* Current Limitation */}
  <div className="bg-yellow-50 admin-dark:bg-yellow-900 border border-yellow-200 admin-dark:border-yellow-700 rounded-lg p-4 mb-6">
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <p className="text-sm text-yellow-700 admin-dark:text-yellow-100">Actualmente tienes 1/1 tiendas. Actualiza para crear más.</p>
      </div>
    </div>
  </div>
</div>
