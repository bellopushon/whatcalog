...
export default function PublicCatalog() {
  ...
  if (!store) {
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4 public-catalog-light">
  ...
  return (
    <div className="min-h-screen bg-gray-50 public-catalog-light">
      {/* Header */}
